...
function triload(vrml) {
	...
	var texturefile = matches ? matches[1] : '';
 ...
 *
 * @param  {Tri} tri  Trimesh with .vertices, .faces, .texturecoords, and
 *                    .textureindices. Will be modified by reference.
